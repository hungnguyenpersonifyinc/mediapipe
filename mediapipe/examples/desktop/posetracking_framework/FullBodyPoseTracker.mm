...
static NSString* const kGraphName = @"pose_tracking_cpu";
...
+ (MPPGraph*)loadGraphFromResource:(NSString*)resource {
    ...
    // [newGraph addFrameOutputStream:kOutputStream outputPacketType:MPPPacketTypeImageFrameBGRANoSwap];
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.mediapipeGraph.maxFramesInFlight = 20;
    }
    return self;
}
